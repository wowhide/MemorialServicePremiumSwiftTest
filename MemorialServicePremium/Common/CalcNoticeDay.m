...
//    NSDate *dateMonthDeathday = [NSDate dateWithTimeIntervalSinceNow:[[NSTimeZone systemTimeZone] secondsFromGMT]];
    ...
    flagsMonthDeathday = NSYearCalendarUnit | NSMonthCalendarUnit | NSDayCalendarUnit | NSHourCalendarUnit | NSMinuteCalendarUnit;
    ...
    flagsDeathday = NSYearCalendarUnit | NSMonthCalendarUnit | NSDayCalendarUnit | NSHourCalendarUnit | NSMinuteCalendarUnit;
    ...
    NSRange range = [calendarMonthDeathday rangeOfUnit:NSDayCalendarUnit inUnit:NSMonthCalendarUnit forDate:dateMonthDeathday];
...
//    NSDate *dateMonthDeathdayBefore = [NSDate dateWithTimeIntervalSinceNow:[[NSTimeZone systemTimeZone] secondsFromGMT]];
    ...
    flagsMonthDeathdayBefore = NSYearCalendarUnit | NSMonthCalendarUnit | NSDayCalendarUnit | NSHourCalendarUnit | NSMinuteCalendarUnit;
    ...
    flagsDeathdayBefore = NSYearCalendarUnit | NSMonthCalendarUnit | NSDayCalendarUnit | NSHourCalendarUnit | NSMinuteCalendarUnit;
...
*/
    ...
    //inUnit:で指定した単位（月）の中で、rangeOfUnit:で指定した単位（日）が取り得る範囲
    NSRange range = [calendarMonthDeathdayBefore rangeOfUnit:NSDayCalendarUnit inUnit:NSMonthCalendarUnit forDate:dateMonthDeathdayBefore];
    //月末日を取得
    NSInteger maxDay = range.length;
...
//    NSDate *dateNextDeathday = [NSDate dateWithTimeIntervalSinceNow:[[NSTimeZone systemTimeZone] secondsFromGMT]];
    ...
    flagsNextDeathday = NSYearCalendarUnit | NSMonthCalendarUnit | NSDayCalendarUnit | NSHourCalendarUnit | NSMinuteCalendarUnit;
...
//    dateNextDeathday = [dateNextDeathday initWithTimeInterval:[[NSTimeZone systemTimeZone] secondsFromGMT] sinceDate:dateNextDeathday];
    ...
    //inUnit:で指定した単位（月）の中で、rangeOfUnit:で指定した単位（日）が取り得る範囲
    NSRange range = [calendarNextDeathday rangeOfUnit:NSDayCalendarUnit inUnit:NSMonthCalendarUnit forDate:dateNextDeathday];
    //月末日を取得
    NSInteger maxDay = range.length;
...
//    NSDate *dateNextDeathdayBefore = [NSDate dateWithTimeIntervalSinceNow:[[NSTimeZone systemTimeZone] secondsFromGMT]];
    ...
    flagsNextDeathdayBefore = NSYearCalendarUnit | NSMonthCalendarUnit | NSDayCalendarUnit | NSHourCalendarUnit | NSMinuteCalendarUnit;
...
/*        NSDateComponents *comps = [[NSDateComponents alloc] init];
    ...
    //inUnit:で指定した単位（月）の中で、rangeOfUnit:で指定した単位（日）が取り得る範囲
    NSRange range = [calendarNextDeathdayBefore rangeOfUnit:NSDayCalendarUnit inUnit:NSMonthCalendarUnit forDate:dateNextDeathdayBefore];
    //月末日を取得
    NSInteger maxDay = range.length;
...
//    NSDate *dateNextDeathday1WeekBefore = [NSDate dateWithTimeIntervalSinceNow:[[NSTimeZone systemTimeZone] secondsFromGMT]];
    ...
    flagsNextDeathday1WeekBefore = NSYearCalendarUnit | NSMonthCalendarUnit | NSDayCalendarUnit | NSHourCalendarUnit | NSMinuteCalendarUnit;
...
//    NSDate *dateDeathday1WeekBefore = [dateGmtDeathday1WeekBefore initWithTimeInterval:[[NSTimeZone systemTimeZone] secondsFromGMT] sinceDate:dateGmtDeathday1WeekBefore];
    ...
    flagsDeathday1WeekBefore = NSYearCalendarUnit | NSMonthCalendarUnit | NSDayCalendarUnit | NSHourCalendarUnit | NSMinuteCalendarUnit;
...
/*        NSDateComponents *comps = [[NSDateComponents alloc] init];
    ...
    //inUnit:で指定した単位（月）の中で、rangeOfUnit:で指定した単位（日）が取り得る範囲
    NSRange range = [calendarNextDeathday1WeekBefore rangeOfUnit:NSDayCalendarUnit inUnit:NSMonthCalendarUnit forDate:dateNextDeathday1WeekBefore];
    //月末日を取得
    NSInteger maxDay = range.length;
